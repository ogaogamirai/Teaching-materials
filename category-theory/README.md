...
```mermaid
graph TD
    Ch0["【序章】なぜ圏論なのか？<br>・要素還元から関係論へ<br>・ルールと自由度の超克<br>・文字式・三角比とのアナロジー"] --> Ch1["【第1章】圏の定義と2つの絶対ルール<br>・対象と射（Arrow）<br>・合成と可換図式<br>・結合則と単位元則"]
    Ch1 --> Ch2["【第2章】周辺から本質を炙り出す<br>・普遍性（Universal Property）<br>・ブラックボックスの同定<br>・米田の補題（Yoneda Lemma）"]
    Ch2 --> Ch3["【第3章】世界と世界を繋ぐ翻訳機<br>・関手（Functor）による構造保存<br>・アナロジーの数学的定式化<br>・自然変換（Natural Transformation）"]
    Ch3 --> Ch4["【第4章】フロンティアと実践応用<br>・複雑ネットワーク×圏論<br>・高次相互作用とマクロノード<br>・量子圏論（DisCoCat）と意味・実存"]
```
...
| 章 | タイトル | 主なテーマ | 原稿リンク |
| :--- | :--- | :--- | :--- |
| **序章** | なぜ圏論なのか？ | 動機、要素から関係へ、代数・三角比アナロジー、自由度の拡張 | [`chapters/00_motivation_and_paradigm_shift.md`](./chapters/00_motivation_and_paradigm_shift.md) |
...
| **第2章** | 周辺から本質を炙り出す | 普遍性（積・余積）、ブラックボックス同定、米田の補題 | [`chapters/02_universal_properties_and_yoneda.md`](./chapters/02_universal_properties_and_yoneda.md) |
...
| **第4章** | フロンティアと実践応用 | 複雑ネットワーク、高次相互作用、量子圏論、知識構造化 | [`chapters/04_applications_and_frontiers.md`](./chapters/04_applications_and_frontiers.md) |
