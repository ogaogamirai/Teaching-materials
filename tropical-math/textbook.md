...
**著者**: Eleanor Arroway (Ellie) × Captain  
**対象読者**: 一般社会人（大人の学び直し、ビジネスパーソン、エンジニア、数学・情報科学の教養を深めたい方）  
**前提知識**: 中学数学レベル（四則演算、不等式、文字式の初歩、グラフや表の読み方）  
**教材バージョン**: 1.2.0 (2026-09-06 / 記号音読ルビ＆教育設計原則 適用版)
