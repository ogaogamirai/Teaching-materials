...
OUTPUT_MD = os.path.join(BASE_DIR, "integers_intuitive_guide_v1.md")
OUTPUT_HTML = os.path.join(BASE_DIR, "integers_intuitive_guide_v1.html")
...
<head>
    ...
    <title>整数が面白いほどわかるシリーズ・直感的完全学習ガイド V1.0</title>
...
<body>
    <div class="container">
        <header>
            <h1>🔢 整数が面白いほどわかるシリーズ・直感的完全学習ガイド V1.0</h1>
            <div class="metadata">最終更新: 2026-06-26</div>
...
def build():
    print("Building integers guide...")
    
    section_files = sorted([f for f in os.listdir(SECTIONS_DIR) if f.endswith(".md")])
    combined_md_lines = []
    
    combined_md_lines.append("# 🔢 整数が面白いほどわかるシリーズ・直感的完全学習ガイド V1.0")
